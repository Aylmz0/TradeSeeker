...
class PerformanceMonitor:
        ...
        try:
            ...
            performance_report = {
                ...
                "trading_activity": {
                    ...
                    "decision_rate": (total_entries / total_decisions * 100)
    ...
    def _generate_recommendations(
        ...
        if coin_performance:
            unprofitable_coins = [
                coin for coin, stats in coin_performance.items() if stats.get("total_pnl", 0) < 0
            ]
    ...
    def _generate_adaptive_suggestions(self, report: dict) -> list[str]:
        ...
        if (
            profitability_index > Config.PERFORMANCE_PROFITABILITY_HIGH
        ...
        # Low profitability index but positive profit factor (big wins, small losses)
            ...
            profitability_index < Config.PERFORMANCE_PROFITABILITY_LOW
        ...
        if (
            decision_rate > Config.PERFORMANCE_DECISION_RATE_HIGH
        ...
        # Low decision rate with good performance
            ...
            decision_rate < Config.PERFORMANCE_DECISION_RATE_LOW
        ...
        try:
            ...
            for coin in coins:
                ...
                if indicators_cache and coin in indicators_cache:
                    ...
                    indicators_15m = coin_indicators.get("15m", {})  # Added 15m
