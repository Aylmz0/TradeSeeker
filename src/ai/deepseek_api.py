    ...
    def _build_system_prompt(self) -> str:
        ...
        system_structure = {
            ...
            "state_vector_schema": {
                ...
                "market_context": "regime (TF_STRONG_BULLISH/TF_STABLE_BULLISH/TF_WEAK_BULLISH/TF_STRONG_BEARISH/TF_STABLE_BEARISH/TF_WEAK_BEARISH/TF_NEUTRAL/CHOPPY), efficiency_ratio (ER < 0.30 = Choppy; ER is averaged 3m+15m, each 10 candles), adx, trend_strength_adx (STRONG/MODERATE/WEAK/NO_TREND), volatility_state (SQUEEZE/EXPANDING/NORMAL), price_location (UPPER_10/LOWER_10/MIDDLE). NOTE: CHOPPY (low efficiency) is a high-risk/low-conviction environment—prefer HOLDing or extreme caution.",
