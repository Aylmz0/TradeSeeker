    ...
    def _build_system_prompt(self) -> str:
        ...
        system_structure = {
            ...
            "enhanced_context_definitions": {
                "trend_1h": "ASCII Sparkline representing 24h price action (Left=Oldest, Right=Newest). Use this to identify visual patterns (e.g., zig-zag, double top).",
                "trend_15m": "ASCII Sparkline representing recent 4h momentum.",
                "range_24h": "High/Low pivot points for the last 24h. Use as support/resistance reference.",
                "tags": "Analytical labels generated by Python (e.g., 'Vol_High', 'RSI_Overbought'). Use these as high-confidence confirmation."
            },
            "response_schema": {
                "format": "JSON",
