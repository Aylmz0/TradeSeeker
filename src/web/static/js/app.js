...
async function refreshPerformance() {
    ...
    try {
        btn.disabled = true;
        btn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Analyzing Performance...';
...
async function runMlDiagnosticScan() {
    ...
    try {
        btn.disabled = true;
        btn.innerHTML = '<i class="fas fa-spinner fa-spin mr-2"></i>Diagnostic Scanning...';
        ...
        setTimeout(() => {
            ...
            showErrorNotification("Scan complete. Monitoring logs for results.");
        }, 3000);
    }
}
